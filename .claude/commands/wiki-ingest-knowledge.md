...
2. Draft or update the pages specified in the plan for the knowledge layer.
   - **Cascade of Checks:** For each entity/concept, establish its relations. Correctly populate the `requires:` and `informs:` arrays in the frontmatter. If a new entity or concept alters the fundamental understanding of the world, proactively create or update a Synthesis page (`knowledge/syntheses/`).
