...
## Connections
- Related to: `wiki/chapters/` — one reader-state page per chapter, linked by chapter number
- Related to: `wiki/foreshadowing/` — `foreshadowing_planted:` and `foreshadowing_resolved:` reference foreshadowing slugs
- Related to: `wiki/rules/` — `constraints_active:` references rule pages governing reader experience at this point
- Referenced by: `wiki/narrative/README.md` — reader model is part of the narrative routing layer
