...
## Connections
- Related to: `wiki/arcs/` — each character links to their arc page
- Related to: `wiki/chapters/` — chapters list which characters appear (`characters:` field)
- Related to: `wiki/conflicts/` — conflicts list character parties
- Referenced by: `wiki/reader-model/` — reader-state tracks character introductions via `terminology_permitted`
