...
## Connections
- Related to: `wiki/characters/` — `parties:` field references character slugs
- Related to: `wiki/themes/` — conflicts link to themes they embody or challenge
- Related to: `wiki/chapters/` — chapters list active conflicts in `conflicts:` field
- Related to: `wiki/arcs/` — conflict resolution trajectories inform arc stages
