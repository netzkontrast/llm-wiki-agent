...
## Connections
- Related to: `wiki/characters/` — characters link to their arc via `arc:` field; arcs reference their `subject:` character
- Related to: `wiki/chapters/` — arc stages reference chapter numbers where stage transitions occur
- Related to: `wiki/conflicts/` — conflict resolution trajectories often parallel arc stages
- Related to: `wiki/timeline/` — arc stage transitions typically align with boundary events
